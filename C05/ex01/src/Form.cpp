...
{
	ostream	<< rhs.getName() << ", Form grade to be signed : " << rhs.getGradeToBeSigned()
			<< ", Form grade to be executed : " << rhs.getGradeToBeExecuted()
			<< ", Form signed status : " << rhs.getSignedStatus() << "." << std::endl;
	return ostream;
}
